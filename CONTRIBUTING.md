...
```
feat: add grid-based figure composition
fix: handle empty subplot list
chore: bump matplotlib floor to 3.10
docs: clarify axes-sharing semantics
```
