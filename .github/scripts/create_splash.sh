...
magick -pointsize 128 -font "./images/splash/google_fonts_montserrat_bold.ttf" "./images/temp.mpc" -gravity East -fill "black" -annotate +997+303 "${DISPLAY_VERSION}" "./images/temp.mpc"
