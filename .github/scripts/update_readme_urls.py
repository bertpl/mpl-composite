    ...
    return [
        ...
        for line in textwrap.dedent(
            f"""
                ...
                ![genbadge-test-count](https://bertpl.github.io/mpl-composite/version_artifacts/v{package_version}/badge-test-count.svg)
                ![genbadge-test-coverage](https://bertpl.github.io/mpl-composite/version_artifacts/v{package_version}/badge-coverage.svg)
                ![mpl-composite logo](https://bertpl.github.io/mpl-composite/version_artifacts/v{package_version}/splash.webp)
            """
        ).splitlines()
        if line
    ]
