...
def test_scale_linlog_ticks_not_implemented() -> None:
    # --- act / assert -----------------
    with pytest.raises(NotImplementedError, match="hand-made Ticks"):
        ScaleLinLog(lin_max=1.0, lin_fraction=0.25).ticks(Range(0.0, 100.0))
