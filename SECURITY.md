...
mpl-composite is pre-1.0 and ships frequent releases. Security fixes land in a
...
[PyPI](https://pypi.org/project/mpl-composite/) to receive security fixes.
...
Use GitHub's [Private Vulnerability Reporting](https://github.com/bertpl/mpl-composite/security/advisories/new)
...
- the mpl-composite version and Python version,
